...
import gr.sr.autoFarm.AutofarmLoader;
...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		if (WeddingConfigs.L2JMOD_ALLOW_WEDDING)
		{
		...
		if ((OfflineTradeConfigs.OFFLINE_TRADE_ENABLE || OfflineTradeConfigs.OFFLINE_CRAFT_ENABLE) && OfflineTradeConfigs.RESTORE_OFFLINERS)
		{
